    ...
    <div className="container flex flex-col px-4 sm:px-6 lg:px-8">
      <section className="mx-auto my-16">
        <div className="flex flex-col items-center justify-center space-y-4">
          <h1 className="text-3xl text-white sm:text-4xl md:text-5xl font-quicksand">
            SlideShare Downloader
          </h1>
          <p className="text-base sm:text-lg font-quicksand text-slate-300">
            Download Free (PPT/PDFs) Presentation
          </p>
        </div>
        <div className="flex flex-col items-center justify-center mt-14">
          <p className="flex tracking-wide text-sm sm:text-md font-quicksand text-slate-300 md:pr-[18rem] pb-2">
            SlideShare Link *
          </p>
          <input
